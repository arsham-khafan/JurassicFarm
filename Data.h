...
public:
    ...
    void RemoveMilk() { data["milk"].toArray().removeFirst(); }
...
public:
    ...
    int getCount() { return data["count"].toInt(); }
    int getArea() { return data["area"].toInt(); }
    ...
    void setArea(int i) { data["area"] = i; }
    ...
    void operator+=(int i) { data["area"] = data["area"].toInt() + i; }
    void operator-=(int i) { data["area"] = data["area"].toInt() - i; }
